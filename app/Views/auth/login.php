                            ...
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <?php if ($config->activeResetter) : ?>
                                        <p class="my-0"><a class="small" href="<?= url_to('forgot') ?>"><?= lang('Auth.forgotYourPassword') ?></a></p>
                                    <?php endif; ?>
                                    <?php if ($config->allowRegistration) : ?>
                                        <p class="my-0"><a class="small" href="<?= url_to('register') ?>"><?= lang('Auth.needAnAccount') ?></a></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
